...
<body>
    ...
    <thead>
    	<tr>
	        <td style="width: 25%;"><?php echo $page->msg("admin.column.name"); ?></td>
	        <td style="width: 25%;"><?php echo $page->msg("admin.column.is_admin"); ?></td>
	        <td style="width: 25%;"><?php echo $page->msg("admin.column.special"); ?></td>
	        <td style="width: 25%;"><?php echo $page->msg("admin.column.option"); ?></td>
	    </tr>
    </thead>
	<?php
	...
	<form class="container" action="./admin" method="POST">
		...
		<button class="btn btn-light"><?php echo $page->msg("admin.button.create"); ?></button>
	</form>
	<?php
	$page->show_footer();
	?>
